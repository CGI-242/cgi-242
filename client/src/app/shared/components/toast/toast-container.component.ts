  ...
  template: `
    <div
      ...
      @for (toast of toastService.toasts(); track toast.id) {
        <div
          [@toastAnimation]
          class="pointer-events-auto w-full rounded-xl shadow-lg border overflow-hidden"
          ...
          <!-- Progress bar -->
          @if (toast.duration > 0) {
            <div class="h-1 w-full" [class]="getProgressBgClasses(toast.type)">
              <div
...
export class ToastContainerComponent {
  ...
  getCloseClasses(type: ToastType): string {
    const classes: Record<ToastType, string> = {
  ...
  getProgressBgClasses(type: ToastType): string {
    const classes: Record<ToastType, string> = {
