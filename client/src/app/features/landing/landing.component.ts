...
export class LandingComponent {
  ...
  products: Product[] = [
    ...
    { id: 'paie242', name: 'Paie 242', description: 'Solution de paie conforme a la legislation congolaise.', icon: 'money', image: 'assets/images/products/paie-242.webp', status: 'coming-soon', url: this.paie242Url, features: ['CNSS integre', 'Bulletins auto', 'Declarations'], gradient: 'bg-gradient-to-br from-green-500 to-green-600' },
    ...
    { id: 'labodec', name: 'Labo Dec', description: 'Laboratoire comptable pour la preparation aux examens.', icon: 'flask', image: 'assets/images/products/labo-dec.webp', status: 'coming-soon', url: '#', features: ['Plan comptable francais', 'Ecritures comptables', 'Cas pratiques'], gradient: 'bg-gradient-to-br from-purple-500 to-purple-600' }
  ];
