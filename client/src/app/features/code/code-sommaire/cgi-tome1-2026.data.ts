            ...
            },
            {
              ...
              sections: [
                ...
                },
                {
                  ...
                  articles: '111-113A',
                  sous_sections: [
                    { sous_section: 1, display: '§1', titre: 'Revenus imposables', articles: '111-111B' },
                    { sous_section: 2, display: '§2', titre: 'Exonération', articles: '111C-111D' },
                    { sous_section: 3, display: '§3', titre: 'Fait générateur et exigibilité', articles: '111E-111E' },
                    { sous_section: 4, display: 'Sec. 2', titre: 'Base d\'imposition', articles: '112-112B' },
                    { sous_section: 5, display: 'Sec. 3', titre: 'Modalités d\'imposition', articles: '113-113A' },
                  ]
                },
                {
                  section: 4,
                  ...
                  articles: '114-116I',
                  sous_sections: [
                    { sous_section: 1, display: '§1', titre: 'Revenus imposables', articles: '114-114' },
                    { sous_section: 2, display: '§2', titre: 'Exonérations', articles: '114A-114C' },
                    { sous_section: 3, display: '§3', titre: 'Territorialité', articles: '114D-114D' },
                    { sous_section: 4, display: '§4', titre: 'Fait générateur et exigibilité', articles: '114E-114E' },
                    { sous_section: 5, display: 'Sec. 2', titre: 'Base d\'imposition', articles: '115-115' },
                    { sous_section: 6, display: 'Sec. 3', titre: 'Modalités d\'imposition', articles: '116-116I' },
                  ]
                },
              ],
            },
