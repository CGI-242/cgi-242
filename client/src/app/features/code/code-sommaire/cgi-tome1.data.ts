      ...
      livres: [
        {
          ...
          chapitres: [
            ...
            },
            {
              ...
              sections: [
                { section: 1, titre: 'Révision des bilans', page: 71 },
                { section: 2, titre: 'Réductions pour investissement', statut: 'abrogé', page: 72 },
                { section: 3, titre: 'Régime exploitations minières', page: 72 },
              ],
            },
            {
              chapitre: 5,
              ...
              sections: [
                { section: 1, titre: 'Taxe d\'apprentissage', statut: 'abrogé', page: 74 },
                { section: 2, titre: 'Taxes sur les terrains', page: 74 },
                { section: 3, titre: 'Taxe spéciale sur les sociétés', page: 78 },
                { section: 5, titre: 'Impôt spécial bons de caisse', page: 79 },
                { section: 6, titre: 'Taxe véhicules de tourisme', page: 80 },
              ],
            },
            {
              chapitre: 6,
              ...
              sections: [
                { section: 1, titre: 'Obligations employeurs', page: 81 },
                { section: 2, titre: 'Commissions et honoraires', page: 84 },
                { section: 6, titre: 'Personnes non-résidentes', page: 86 },
                { section: 7, titre: 'Plus-values sur titres', page: 88 },
              ],
            },
          ],
        },
      ...
      titres: [
        {
          ...
          chapitres: [
            { chapitre: 1, titre: 'Impôts et taxes obligatoires', page: 90 },
            { chapitre: 2, titre: 'Taxes facultatives', page: 104 },
            { chapitre: 3, titre: 'Centimes additionnels à certains impôts', page: 105 },
          ],
        },
      ],
    },
      ...
      titres: [
        {
          ...
          chapitres: [
            { chapitre: 1, titre: 'Sanctions pour défaut de déclaration', page: 106 },
            { chapitre: 2, titre: 'Prescriptions', page: 109 },
            { chapitre: 3, titre: 'Changement du lieu d\'imposition', page: 110 },
            { chapitre: 4, titre: 'Conventions fiscales', page: 110 },
            { chapitre: 5, titre: 'Vérification des contribuables', page: 111 },
            { chapitre: 6, titre: 'Droit de communication', page: 116 },
            { chapitre: 7, titre: 'Commission des impôts', page: 119 },
            { chapitre: 8, titre: 'Secret professionnel', page: 120 },
            { chapitre: 9, titre: 'Marchés publics', page: 121 },
          ],
        },
        {
          titre: 2,
          titre_libelle: 'Rôles',
          chapitres: [
            { chapitre: 1, titre: 'Émission des rôles', page: 121 },
            { chapitre: 2, titre: 'Approbation des rôles', page: 121 },
            { chapitre: 3, titre: 'Mise en recouvrement', page: 122 },
          ],
        },
        {
          titre: 3,
          ...
          chapitres: [
            { chapitre: 1, titre: 'Juridictions contentieuse et gracieuse', page: 123 },
            { chapitre: 2, titre: 'Juridiction contentieuse', page: 124 },
            { chapitre: 3, titre: 'Juridiction gracieuse', page: 127 },
            { chapitre: 4, titre: 'Dispositions communes', page: 128 },
          ],
        },
        {
          titre: 4,
          ...
          chapitres: [
            { chapitre: 1, titre: 'Dispositions générales', page: 128 },
            { chapitre: 2, titre: 'Dispositions spéciales', page: 136 },
          ],
        },
      ],
    },
